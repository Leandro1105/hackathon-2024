...
const Questoes5 = ({ navigation }) => { // Recebe a prop navigation
  const [responses5, setresponses5] = useState({}); // Estado para armazenar as respostas
    ...
    <View style={styles.container}>
      ...
      <View style={styles.buttonContainer}>
        <TouchableOpacity 
          ...
          onPress={() => navigation.navigate('Questoes4')} // Navega para Questoes.js
        >
